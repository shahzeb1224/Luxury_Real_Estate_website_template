...
const SupportCTA = React.forwardRef(({ className = '', ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <p className="text-navy-600 mt-3 max-w-2xl mx-auto">
          Our team of real estate experts is here to help. Reach out to us for personalized
          assistance.
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 mt-4 text-sm text-navy-500">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="hover:text-navy-700 transition-colors cursor-pointer">Live Chat</span>
          </div>
          <span className="text-navy-300 hidden sm:block">|</span>
          <div className="flex items-center gap-2">
            <span className="text-navy-400 text-xs">Available 24/7</span>
          </div>
        </div>
...
export default React.memo(SupportCTA);
